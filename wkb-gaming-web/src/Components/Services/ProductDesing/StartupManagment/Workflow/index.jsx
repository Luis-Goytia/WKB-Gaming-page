...
export const Workflow = () => {
  return (
    <div>
      ...
      <div>
        <div className={Styles.subtitle}>
          <h5>2 - Product and Market Testing</h5>
        </div>
        <div className={Styles.text7}>
          <p>
      ...
      <div>
        ...
        <div className={Styles.text1}>
          <p>
            ...
            folks to check it out. Also, be sure you can produce enough to meet
            demand if your product takes off.
          </p>
        </div>
      </div>
      <br />
      <div>
        ...
        <div className={Styles.text9}>
          <p>
            ...
            Even if you’re doing well, maybe you can do better. It’s good to
            revisit the previous growth stages. Be constantly attuned to
            feedback on your product and marketing strategy. There may be an
            opportunity to improve your product, develop new offerings, improve
            your distribution through current channels or even explore new ways
            to sell.
          </p>
        </div>
      </div>
